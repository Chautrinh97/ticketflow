...
const (
	EventService_GetEvent_FullMethodName = "/ticketflow.event.EventService/GetEvent"
)
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ticketflow.event.EventService",
